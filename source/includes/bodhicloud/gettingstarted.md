...
If you enter your credentials (username and password) and click Explore, you will see a list of Types and their APIs which you can access for your namespace.  The Bodhi Cloud APIs are REST APIs which returns JSON for all responses.  
